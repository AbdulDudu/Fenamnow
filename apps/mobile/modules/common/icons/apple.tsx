...
export const AppleIcon = createIcon({
  ...
  path: (
    <>
      <Defs>
        <Mask id="ipTApple0">
          <G fill="none">
            <Path
              fill="#fff"
              d="M23.911 11.318c.082-2.232.71-4.192 1.866-5.83c1.163-1.647 3.086-2.817 5.717-3.48l.055.243v.424c0 .961-.233 2.064-.693 3.276c-.483 1.174-1.237 2.28-2.238 3.277c-.936.879-1.803 1.46-2.569 1.723c-.252.076-.599.15-1.018.217c-.372.058-.745.108-1.12.15Z"
            />
            <Path
              fill="#555"
              stroke="#fff"
      ...
      <Path fill="#000000" d="M0 0h48v48H0z" mask="url(#ipTApple0)" />
    </>
  )
});
